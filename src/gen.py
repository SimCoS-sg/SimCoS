...
model_name_path = "/home/ssd_data/zhu/LOT-LongLM/KEPLM/tmp/outgen"
name = "data"
task_name = "test"
...
with open("./data/test.source", "r") as fin:
    ipt = [line.strip() for line in fin]
with open("./data/test.target", "r") as fin:
    opt = [line.strip() for line in fin]
import sys
...
file_out = model_name_path + "/result.txt"
...
with open(file_out, "w") as fout:
    ...
    with torch.no_grad():
        while ed < len(ipt):
            ...
            gen = model.generate(input_ids, do_sample=True, max_length=512, top_k=40, decoder_start_token_id=1)
