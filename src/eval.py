...
def main():
#     python eval.py result.jsonl test.jsonl
# /home/ssd_data/zhu/LOT-LongLM/KEPLM/tmp/outgen/generated_predictions.txt

    # argv = sys.argv
    # print("预测结果：{}, 测试集: {}".format(argv[1], argv[2]))
    golden_json = "/home/ssd_data/zhu/LOT-LongLM/KEPLM/data/test.jsonl"
    predictions_txt = "/home/ssd_data/zhu/LOT-LongLM/KEPLM/tmp/outgen_mymodel_alpha_1/generated_predictions.txt"
    print(compute(golden_file=golden_json, pred_file=predictions_txt))
